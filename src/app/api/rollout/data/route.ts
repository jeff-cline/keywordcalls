...
export async function GET(req: NextRequest) {
  ...
  const targets = [...green, ...recent].map((t) => ({ phone: t.phone, name: t.name, email: t.email, city: t.city, state: t.state, calledBack: t.calledBack, calledBackAt: t.calledBackAt, landedAt: t.landedAt, connectSec: t.connectSec, billable: t.billable, endedBy: t.endedBy, recordingUrl: t.recordingUrl, sentAt: t.at }));
