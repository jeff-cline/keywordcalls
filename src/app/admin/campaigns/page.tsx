...
export default async function AdminCampaignsPage() {
  ...
  const rows = campaigns.map((c) => ({
    ...
    emailSubject: c.emailSubject, emailBody: c.emailBody, routingNumber: c.routingNumber,
    dialedCount: c.dialedCount, connectedCount: c.connectedCount, deliveredCount: c.deliveredCount, filteredCount: c.filteredCount, revenueCents: c.revenueCents,
